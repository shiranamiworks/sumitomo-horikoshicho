  ...
  <section class="sections sec01 clearfix">
    <div class="wrap">
      ...
      <ul class="lists list03">
        ...
        <li>
          <p class="tit-img">スプリンクラー</p>
          <p class="lead">11階以上の住戸には、熱を感知すると自動的に散水する、スプリンクラーを設置し、迅速な初期消火への対応を実現します。</p>
        </li>
        <li>
          <p class="tit-img">耐震ラッチ</p>
          <p class="lead">キッチンの吊戸棚、洗面化粧台の三面鏡収納の扉には、地震の揺れによって扉が開いて、収納物が落下しないように、耐震ラッチを設置。住まう方の安全に配慮しています。</p>
        </li>
        </ul>
      <ul class="lists list05">
        <li>
          ...
          <div class="image">
          <img src="./images/structure03/img07.png" alt="" class="pc"><p class="annotation gothic pc left">（概念図）</span><p class="annotation gothic right pc">（概念図）</span></p>
          </div>
          <div class="image">
          <img src="./images/structure03/img07-sp.png" alt="" class="tb"><p class="annotation gothic tb left">（概念図）</span><p class="annotation gothic right tb">（概念図）</span></p>
          </div>
        </li>
        <li class="mr0">
          <p class="tit-img">ホーム保安灯</p>
