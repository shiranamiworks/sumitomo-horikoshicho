...
<main>
  ...
  <section class="intro sections clearfix">
    <div class="inner">
      ...
      <div class="images img01">
        ...
        <figure class="tb"><img src="./images/access/intro01.jpg" class="zoomImg tb" alt=""/></figure>
      ...
      <ul class="column03">
        <li>
          <div class="image">
            <img src="./images/access/intro02.jpg">
          </div>
          <p class="caps">① 錦糸公園（約550m／徒歩7分）</p>
          <p class="info"><span>1</span>駅を出てすぐの並木道</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/access/intro03.jpg">
          </div>
          <p class="caps">② 錦糸公園（約300m／徒歩4分）</p>
          <p class="info"><span>2</span>プロムナード</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/access/intro04.jpg">
          </div>
          <p class="caps">③ オリナス錦糸町（約380m／徒歩5分）</p>
          <p class="info"><span>3</span>オリナス錦糸町と錦糸公園の歩道</p>
        </li>
      </ul>
    </div><!-- inner -->
  </section><!-- intro -->
  ...
  <div class="inner">
    <p class="tit">TRAIN ACCESS</p>
    <p class="text">東京メトロ半蔵門線で大手町へ直通13分<sup>※1</sup>。<br>都心を自在にする軽快なアクセス。</p>
  </div><!-- inner -->
      <div class="images img01">
        <figure class="pc"><img src="./images/access/train01.jpg" class="sp-hide" alt="東京メトロ半蔵門線路線概念図"></figure>
        <figure class="tb"><img src="./images/access/train01.jpg" class="zoomImg tb" alt=""/></figure>
  ...
  <div class="inner01">
    ...
    <div class="swipe sp">
      <img src="./images/access/icon_swipe.svg" alt="">
    </div>
    <p class="txt txt01">JR「錦糸町」駅より</p>
    <ul class="column02">
      <li>
        <div class="image">
  ...
  <section class="box sections clearfix">
    <div class="inner">
      <ul class="column02">
        <li>
          <div class="image">
