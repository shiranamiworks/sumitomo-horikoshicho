...
<main>
  ...
  <div class="location-link location-link--2">
    <a href="location01.html"><p>心地よい錦糸町ライフ</p></a>
    <a href="location02.html" class="current"><p>東京イーストエリア</p></a>
  </div>
  ...
  <section class="intro sections clearfix">
    <div class="inner">
      ...
      <p class="txt">新しい出逢いと発見に満ちた、<br class="pc">旅するような日常へ。</p>
    ...
    <ul class="column03">
      <li>
        <a href="#moments" class="scroll">
          ...
          <img src="./images/location02/btn01-sp.png" alt="" class="tb">
        </a>
      </li>
      <li>
        <a href="#green">
          <img src="./images/location02/btn02.png" alt="" class="pc">
          <img src="./images/location02/btn02-sp.png" alt="" class="tb">
        </a>
      </li>
      <li>
        <a href="#tokyo">
          <img src="./images/location02/btn03.png" alt="" class="pc">
          <img src="./images/location02/btn03-sp.png" alt="" class="tb">
        </a>
      </li>
    </ul>
    </div>
  ...
  <div class="sections moments clearfix" id="moments">
    <div class="inner">
      ...
      <ul class="list">
        ...
        <li>
          <p class="lead">東京スカイツリー<sup>&reg;</sup>の足元に広がる<br class="pc">「東京ソラマチ」をはじめ、<br class="pc">周辺には、家族で楽しめる<br class="pc">大規模な商業施設が充実。<br>週末のちょっとしたお出かけも<br class="pc">特別な時間に変わっていきます。</p>
        </li>
      </ul>
      <ul class="column03">
        <li>
  ...
  <div class="sections green clearfix" id="green">
    <div class="inner">
      ...
      <ul class="list">
        ...
        <li>
          <p class="lead">住まいのすぐそばにある<br class="pc">錦糸公園の他にも、<br class="pc">周辺には水と緑の潤いに溢れた<br class="pc">大規模な公園が点在。<br>ピクニックの行き先も、<br class="pc">よりどりみどりの環境です。</p>
        </li>
      </ul>
      <ul class="column03">
        <li>
  ...
  <div class="sections tokyo clearfix" id="tokyo">
    <div class="inner">
      ...
      <ul class="list">
        ...
        <li>
          <p class="lead">東京スカイツリー<sup>&reg;</sup>に浅草仲見世通り、<br class="pc">隅田川クルーズに大相撲観戦。<br>世界の人々を魅了する<br class="pc">TOKYOの人気観光スポットも、<br class="pc">この住まいなら、<br class="pc">日常のテリトリーになります。</p>
        </li>
      </ul>
      <ul class="column03">
        <li>
