...
<main>
  ...
  <section class="sections sec01 clearfix">
    <div class="wrap">
      ...
      <ul class="lists list01 clearfix">
        ...
        <li>
        <p class="tit-img"><span>明るく開放的な</span>対面フラットカウンター</p>
      ...
      <ul class="lists list02">
        <li>
          <p class="tit-img"><span>汚れもさっと拭き取れる</span>コンロ前パネル</p>
        ...
        <li>
          <p class="tit-img"><span>洗練されたデザインの</span>レンジフード</p>
      ...
      <ul class="lists list03">
        ...
        <li>
          <p class="tit-img mini"><span>美しさと耐久性を兼ね備えた</span>ショット社製 ガラストッププレート</p>
          ...
          <div class="image img-sub tb">
            <img src="./images/equipment01/img09-02.jpg" alt="" class="">
          </div>
        </li>
        <li>
          <div class="image pc">
        ...
        <li>
          ...
          <li>
            <p class="tit-img"><span>上質なデザインと優れた機能性の</span>自動温度調節機能付コンロ</p>
            <p class="lead">自動温度調節機能を備え、一定温度に火力をコントロール。震度4程度以上の揺れを感知すると自動で消火するなど、充実の安心・便利機能。ボタンをコンロ前面にフラット収納できるシャープなデザインです。<span>※自動温度調節機能は小バーナーにはございません。</span></p>
          </li>
          <li>
           <p class="tit-img mini"><span>引き出しがスムーズに開閉できる</span>ブルム社製フルエクステンションレール</p>
            <p class="lead">引き出しには一番奥までスムーズに引き出せる世界有数のオーストリア・ブルム社製のフルエクステンションレールを採用しています。さらに、ブルモーション機能を内蔵しているため、勢いよく閉めても手前で機構が働いて、衝撃を和らげ、ゆっくりと静かに引き込みます。<span>※スパイスケースを除く。</span></p>
          </li>
          <li>
            <p class="tit-img"><span>水や食器の当たる音を低減した</span>静音シンク</p>
  ...
  <section class="sections sec02 clearfix">
    <div class="wrap">
      ...
      <ul class="lists list01 clearfix">
        <li>
          <p class="tit-img"><span>鏡裏に収納スペースを設けた</span>三面鏡洗面化粧台（手元照明付）</p>
        ...
        <li>
          <p class="tit-img"><span>インテリア性と機能性に富む</span>洗面ボウル</p>
          <p class="lead">カウンターとボウルはお手入れのしやすい継ぎ目のない一体成形で、美しい光沢の有機ガラス系人造大理石仕様。</p>
          <div class="image tb">
        ...
        <li>
          <p class="tit-img"><span>ヘッドが引き出せる</span>シングルレバー水栓</p>
      ...
      <ul class="lists list02 clearfix">
        <li>
          <p class="tit-img"><span>スペースを有効利用した</span>ヘルスメータースペース</p>
          <p class="lead">洗面化粧台のキャビネットの下部を有効利用し、体重計の収納に便利なヘルスメータースペースを設けています。<span>※ヘルスメーターのサイズによっては収納できないもの
          もあります。</span></p>
          <div class="image tb">
        ...
        <li>
          <p class="tit-img"><span>タオルや肌着類などの収納に便利な</span>リネン庫</p>
      ...
      <ul class="lists list03 clearfix">
        ...
        <p class="tit-img"><span>スイッチひとつでバスタイムの準備ができる</span>オートバスシステム（リモコン通話機能付）</p>
          ...
          <div class="image">
            <img src="./images/equipment01/img16.png" alt="" class="">
          </div>
        </li>
        <li>
          <ul class="list03-01">
          <li>
            <p class="tit-img"><span>温まったお湯を冷めにくくする</span>保温浴槽</p>
            <p class="lead">専用のフロフタと浴槽保温材で温まったお湯が冷めにくくなる保温浴槽を採用しました。</p>
          </li>
          <li>
            <p class="tit-img"><span>雨の日でも洗濯物が乾かせる</span>大阪ガス浴室暖房乾燥機</p>
            <p class="lead">乾燥機能で雨の日でも洗濯物を乾かすことができ、換気によりカビの発生も抑制できる大阪ガスの浴室暖房乾燥機を採用しました。</p>
            <div class="image">
      ...
      <li>
          <p class="tit-img"><span>お気に入りの音楽を聴きながら快適バスタイム</span>ミュージックリモコン</p>
        ...
        <li>
          <p class="tit-img"><span>すっきりとしたデザイン</span>手洗いカウンター付トイレ</p>
          <p class="lead">トイレには、コンパクトな手洗いカウンターを設けています。すっきりとしたデザインで見た目にも広さとゆとりを感じることができます。</p>
          <div class="image tb">
            <img src="./images/equipment01/img19.jpg" alt="" class="">
            <p class="annotation gothic">参考写真1</p>
          </div>
        </li>
        <li>
          <p class="tit-img"><span>ローシルエットでデザインすっきり</span>ローシルエットタンクトイレ</p>
          <p class="lead">コンパクトなフォルムを実現したローシルエットタンクトイレを採用。温水シャワーが快適に使え、着座センサーによりノンタッチで便器自動洗浄も行なう先進の機能付きです。また、洗浄使用水量が少ない節水タイプで、経済面・環境面に優しい仕様です。</p>
        </li>
        <li>
          <div class="image pc">
            <img src="./images/equipment01/img18.png" alt="" class="">
  ...
  <p class="page-annotation js-scroll wrap clearfix">※掲載の参考写真1は本物件と同仕様のコンセプトルーム（総合マンションギャラリー秋葉原館）を撮影（2022年8月）したもので、本物件のものではありません。。家具・調度品等オプション仕様は販売価格に含まれておりません。<br>※掲載の参考写真2はメーカーカタログ等の参考写真であり本物件のものではありません。<br>※設備・仕様はタイプにより異なります。</p></div>
</main>
